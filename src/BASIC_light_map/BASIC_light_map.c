...
int main()
{
    ...
    create_shader(&obj_shader, "shaders/light_map.vert", "shaders/light_map.frag");
    ...
    unsigned int emission_texture = load_texture("textures/matrix.jpg");

    glUseProgram(obj_shader);
    set_uniform_int(&obj_shader, "material.diffuse", 0);
    set_uniform_int(&obj_shader, "material.specular", 1);
    set_uniform_int(&obj_shader, "material.emission", 2);
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        set_uniform_vec3(&obj_shader, "light.specular", GLM_VEC3_ONE);
